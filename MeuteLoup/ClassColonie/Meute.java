...
public class Meute {
    ...
    /**
     * Affiche les caractéristiques d'une meute
     */
    ...
    public void ajouterLycanthrope(Lycanthrope lycanthrope) {
        ...
        System.out.println(TextColor.BRIGHT_BLUE_BOLD+lycanthrope.getNom()+TextColor.RESET+" ajouté à la meute : "+TextColor.BRIGHT_RED_BOLD+this.getNomMeute()+TextColor.RESET);
    }
	...
	/**
	 * Méthode pour déclarer les lycanthropes omega
	 */
    ...
    /**
     * Effectue un tri Insertion par rapport au facteur de domination des lycans
     */
    ...
    /**
     * Traduit le rang des lycanthropes en rang lettré
     */
    ...
    /**
     * Affiche le statut des Lycanthropes  dans la meute
     * @param role
     * @param lycan
     */
    private void afficherRole(String role, List<Lycanthrope> lycan) {
    	String couleur = null;
    	if(role=="Alpha") {
    		couleur=TextColor.RED;
    	}
    	if(role=="Bêta") {
    		couleur=TextColor.BLUE;
    	}
    	if(role=="Gamma") {
    		couleur=TextColor.GREEN;
    	}
    	if(role=="Delta") {
    		couleur=TextColor.YELLOW;
    	}
    	if(role=="Omega") {
    		couleur=TextColor.MAGENTA;
    	}
        System.out.println("\n"+couleur+ role +TextColor.RESET+ " :");
        lycan.stream()
